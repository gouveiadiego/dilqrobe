  ...
  return <div className="space-y-6">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <select id="client" className="flex-1 px-3 py-2 border rounded-md" value={newService.client_id} onChange={e => {
          ...
          <div className="space-y-2">
            ...
            <Input id="start_date" type="date" value={newService.start_date} onChange={e => setNewService({
            ...newService,
          ...
          <div className="space-y-2">
            ...
            <Input id="service_description" value={newService.service_description} onChange={e => setNewService({
            ...newService,
          ...
          <div className="space-y-2">
            ...
            <Input id="stage" value={newService.stage} onChange={e => setNewService({
            ...newService,
          ...
          <div className="space-y-2">
            ...
            <Input id="status" value={newService.status} onChange={e => setNewService({
            ...newService,
          ...
          <div className="space-y-2">
            ...
            <Input id="amount" type="number" value={newService.amount} onChange={e => setNewService({
            ...newService,
          ...
          <div className="space-y-2">
            ...
            <Select value={newService.payment_status} onValueChange={value => setNewService({
            ...newService,
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border">
                ...
                <div className="py-4 space-y-4">
                  ...
                  services
                      ...
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <Button variant="outline" size="sm" onClick={() => handleSharePortalLink(clientId)}>
                          Copiar Link
                        </Button>
                      </div>
        ...
        <div className="flex gap-4 mb-4">
          <div className="flex-1">
            <Input placeholder="Buscar em todas as colunas..." value={filterText} onChange={e => setFilterText(e.target.value)} className="max-w-sm" />
          </div>
          <Input type="month" value={filterMonth} onChange={e => setFilterMonth(e.target.value)} className="w-40" />
          <select className="border rounded-md px-3" value={filterStatus} onChange={e => setFilterStatus(e.target.value)}>
        ...
        <Table>
          ...
          <TableBody>
            {filteredServices.map(service => <TableRow key={service.id}>
              ...
              <TableCell>
                  <Select value={service.payment_status} onValueChange={async value => {
                try {
                  const {
                    error
                  } = await supabase.from('services').update({
                  ...
                  toast.error("Erro ao atualizar status");
                    ...
                    <SelectTrigger className={`w-[110px] ${service.payment_status === 'paid' ? 'text-green-600' : service.payment_status === 'canceled' ? 'text-red-600' : 'text-orange-600'}`}>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="pending">Pendente</SelectItem>
      ...
      <Dialog open={!!editingService} onOpenChange={() => setEditingService(null)}>
        <DialogContent className="max-w-2xl">
          ...
          {editingService && <form onSubmit={handleUpdate} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="edit-start_date">Data</Label>
                  <Input id="edit-start_date" type="date" value={format(new Date(editingService.start_date), "yyyy-MM-dd")} onChange={e => setEditingService({
                ...editingService,
                start_date: e.target.value
              })} />
                </div>
                <div>
                  ...
                  <Input id="edit-client_name" value={editingService.client_name} onChange={e => setEditingService({
                ...editingService,
                ...
                <div>
                  ...
                  <Input id="edit-company_name" value={editingService.company_name} onChange={e => setEditingService({
                ...editingService,
                company_name: e.target.value
              })} />
                </div>
                <div>
                  ...
                  <Input id="edit-service_description" value={editingService.service_description} onChange={e => setEditingService({
                ...editingService,
                service_description: e.target.value
              })} />
                </div>
                <div>
                  ...
                  <Input id="edit-stage" value={editingService.stage} onChange={e => setEditingService({
                ...editingService,
                stage: e.target.value
              })} />
                </div>
                <div>
                  ...
                  <Input id="edit-status" value={editingService.status} onChange={e => setEditingService({
                ...editingService,
                status: e.target.value
              })} />
                </div>
                <div>
                  ...
                  <Input id="edit-amount" type="number" value={editingService.amount} onChange={e => setEditingService({
                ...editingService,
                amount: Number(e.target.value)
              })} />
                </div>
               <div>
                  ...
                  <Select value={editingService.payment_status} onValueChange={value => setEditingService({
                ...editingService,
                payment_status: value
              })}>
                    <SelectTrigger>
