  ...
  return <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 space-y-4">
      <div className="flex gap-4 items-center">
        <div className="relative flex-1">
          <Input placeholder="Digite sua tarefa e pressione Enter..." value={title} onChange={e => setTitle(e.target.value)} className="w-full bg-white border-gray-200 text-gray-900 placeholder:text-gray-500 pr-36 focus:ring-purple-200" onKeyDown={e => {
