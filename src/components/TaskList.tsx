          ...
          <div className="space-y-4 pr-4">
            {activeTasks.length === 0 ? (
              <div className="text-center py-16 rounded-xl border border-dashed border-gray-200 bg-gray-50/50 backdrop-blur-sm">
                <div className="w-16 h-16 rounded-full bg-gray-100 mx-auto flex items-center justify-center mb-4 relative shimmer-effect">
          ...
          {groupedCompletedTasks.thisWeek.length > 0 && (
            <div className="space-y-3">
              <button
                ...
                className="flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-dilq-accent transition-colors px-3 py-2 rounded-lg hover:bg-gray-50 w-full backdrop-blur-sm"
              >
                {showThisWeek ? (
