      ...
      <Table wrapperClassName="max-h-[500px] md:max-h-[600px] border border-slate-200 rounded-md">
        ...
        <TableBody>
          {localFilteredTransactions.map(transaction => (
            <TableRow key={transaction.id} className={`group transition-colors ${transaction.is_paid ? 'bg-emerald-100/80 hover:bg-emerald-200/60' : 'bg-white hover:bg-amber-50/40'}`}>
              <TableCell className={`sticky left-0 z-10 border-r border-slate-100 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.05)] transition-colors whitespace-nowrap align-top ${transaction.is_paid ? '!bg-emerald-100/80 group-hover:!bg-emerald-200/60' : 'bg-white group-hover:bg-amber-50/40'}`}>
              ...
              <TableCell className={`align-top py-3 transition-colors ${transaction.is_paid ? 'bg-emerald-100/80 group-hover:bg-emerald-200/60' : ''}`}>
              ...
              <TableCell className={`sticky right-0 z-10 border-l border-slate-100 shadow-[-2px_0_5px_-2px_rgba(0,0,0,0.05)] transition-colors align-top py-3 ${transaction.is_paid ? '!bg-emerald-100/80 group-hover:!bg-emerald-200/60' : 'bg-white group-hover:bg-amber-50/40'}`}>
