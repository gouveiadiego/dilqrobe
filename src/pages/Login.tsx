...
export const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-purple-500/20 to-pink-500/20">
      <div className="w-full max-w-md p-8 space-y-8">
        ...
        <div className="absolute top-0 left-0 w-full h-full -z-10 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-gradient-to-tr from-purple-500/30 to-pink-500/30 rounded-full filter blur-3xl transform -translate-x-1/2 translate-y-1/2" />
        </div>
      </div>
    </div>
  );
